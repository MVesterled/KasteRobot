...
int main(int argc, char* argv[])
{
    ...
    cout << "is connected: " << rtde_receive.isConnected() << endl;

    while(true) {
        vector<double> joint_positions = rtde_receive.getActualQ();
        //cout << "Base: " << joint_positions[0] * (180.0/3.141592653589793238463) << endl;
        cout << "Shoulder: " << joint_positions[1] * (180.0/3.141592653589793238463) << endl;
        //cout << "Elbow: " << joint_positions[2] * (180.0/3.141592653589793238463) << endl;
        //cout << "Wrist 1: " << joint_positions[3] * (180.0/3.141592653589793238463) << endl;
        //cout << "Wrist 2: " << joint_positions[4] * (180.0/3.141592653589793238463) << endl;
        //cout << "Wrist 3: " << joint_positions[5] * (180.0/3.141592653589793238463) << endl;
    }
